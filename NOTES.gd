...
#
	...
	### PRIOR TO FIXING STUFF AS RANDOMIZERS:
...
#var material_sounds_2: Dictionary = {}
#var footstep_material_sounds_all: Dictionary = {}
...
#
##@export var footsteps_master: Dictionary = {
	##"metal": AudioStreamRandomizer,
	##"grass": AudioStreamRandomizer,
##}
#@export var metal_footstep_sounds_2: AudioStreamRandomizer
#@export var grass_footstep_sounds_2: AudioStreamRandomizer
...
#func _ready():
	...
	#material_sounds_2 = {
		...
		#"metal": metal_footstep_sounds
	#}
	#footstep_material_sounds_all = {
		#"metal": metal_footstep_sounds_2,
		#"grass": grass_footstep_sounds_2,
	#}
	#
...
### Select the sound at the current index
	...
	#var sound = footstep_material_sounds_all[material]
#
